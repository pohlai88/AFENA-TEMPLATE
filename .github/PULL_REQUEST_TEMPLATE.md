...
<!-- Provide screenshots, logs, or test output if applicable -->
...
- [ ] Coverage threshold met (80% lines, 80% functions, 75% branches)
...
- [ ] Requires security review (cc @security-team)
...
- [ ] Squash and merge commits appropriately
