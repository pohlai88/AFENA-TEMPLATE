...
<!-- Signature: sha256:3348099552a5ee83c0fe8b6a64d42f63cb8e5b235b0e5d15a298ff6c420e8b2d -->
# afenda-monorepo
## Structure
...
│   ├── logger/
│   ├── migration/
│   ├── observability/  # OpenTelemetry instrumentation, metrics, and observability utilities for afenda
│   ├── search/
│   ├── typescript-config/
│   ├── ui/
│   └── workflow/
...
| `pnpm lint:ci` | `turbo run lint:ci --continue` |
...
| `pnpm type-check` | `turbo run type-check --continue` |
...
- ✅ Synchronized all 64 TypeScript configurations (see [CONFIG-SYNC-REPORT.md](docs/CONFIG-SYNC-REPORT.md))
- ✅ Next.js 16 optimizations with `verbatimModuleSyntax`
- ✅ Turborepo caching enhancements
- ✅ pnpm workspace optimizations (.npmrc)
...
**Lint & type debugging:** Cursor skill at `.cursor/skills/lint-types-debug/` —
