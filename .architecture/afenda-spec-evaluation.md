...
| Spec                                                                      | Afenda                                              | Status            |
| ------------------------------------------------------------------------- | --------------------------------------------------- | ----------------- |
| outbox_events (entity_type, entity_id, payload, processed_at)             | workflow\_\*\_outbox for workflow; no search outbox | ❌                |
...
- migration\_\* (internal)
- meta\_\* (aliases, lineage, quality)
