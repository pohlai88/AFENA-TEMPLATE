...
> **Superseded** by [database.architecture.md](./database.architecture.md) §1 Overview, §9 Governance.
...
| Target                                                                          | Afenda                                                                                 | Status |
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------ |
| Workflow defs/instances, approvals, posting batches, idempotency, outbox, locks | workflow*definitions, workflow_instances, approval*_, doc*postings, workflow*_\_outbox | ✅     |
...
| Target                                         | Afenda                                                                     | Status              |
| ---------------------------------------------- | -------------------------------------------------------------------------- | ------------------- |
| FKs on all \*\_id columns (unless whitelisted) | FKs on migration*\*, meta*\*, roles, entity_view_fields, advisory_evidence | ⚠️ Sparse on domain |
...
| Control    | workflow\_\*, approvals, outbox_events, idempotency_keys, locks                            | workflow*\*, approval*_, workflow\__\_outbox, doc_postings | ✅                 |
