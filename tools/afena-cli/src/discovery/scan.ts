...
import { loadPreviousDiscovery, loadPreviousSignature, hasContentChanged, hasNewWarnings } from '../capability/diff';
import { scanScripts } from '../capability/script-scanner';
import { computeSignature } from '../capability/signature';
import { scanTools, scanStandaloneScripts } from '../capability/tool-scanner';
import { log, isVerbose } from '../core/logger';
