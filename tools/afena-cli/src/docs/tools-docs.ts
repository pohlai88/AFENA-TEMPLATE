...
function generateReadme(): string {
  ...
  lines.push('');
  lines.push('> **Auto-generated documentation** - Run `pnpm afenda docs` to regenerate');
  lines.push('');
  lines.push('Unified development and maintenance utilities for the afenda monorepo.');
  lines.push('');
  ...
  lines.push('pnpm afenda readme gen');
  lines.push('');
  lines.push('# Run housekeeping checks');
  lines.push('pnpm afenda housekeeping');
  lines.push('```');
  lines.push('');
  ...
  lines.push('```');
  lines.push('tools/');
  lines.push('└── afenda-cli/                    # Unified CLI tool');
  lines.push('    ├── src/');
  ...
  lines.push('pnpm afenda bundle --skip-readme');
  lines.push('pnpm afenda bundle --skip-meta');
  lines.push('pnpm afenda bundle --skip-housekeeping');
  lines.push('```');
  lines.push('');
  lines.push('**Tasks:**');
  ...
  lines.push('');
  lines.push('```bash');
  lines.push('pnpm afenda readme gen           # Generate all READMEs');
  lines.push('pnpm afenda readme gen --dry-run # Preview changes');
  lines.push('pnpm afenda readme validate      # Validate existing READMEs');
  lines.push('```');
  lines.push('');
  ...
  lines.push('');
  lines.push('```bash');
  lines.push('pnpm afenda housekeeping         # Run all checks');
  lines.push('pnpm afenda housekeeping --json  # JSON output');
  lines.push('```');
  lines.push('');
  ...
  lines.push('');
  lines.push('```bash');
  lines.push('pnpm afenda meta check           # Validate metadata');
  lines.push('pnpm afenda meta scan            # Scan for capabilities');
  lines.push('```');
  lines.push('');
  ...
  lines.push('---');
  lines.push('');
  lines.push('*Auto-generated by `pnpm afenda docs` - Do not edit manually*');
  lines.push('');
...
function generateGuide(): string {
  ...
  lines.push('');
  lines.push('1. **Auto-generate** - Use `pnpm afenda docs`');
