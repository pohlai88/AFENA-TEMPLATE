...
import { createTimer, generateMarkdownReport, generateReport, getTimestamp } from './reporter';
...
export class ReportBuilder {
   ...
   */
  private getStatus(_total: number, success: number, failed: number): 'success' | 'partial' | 'failed' {
