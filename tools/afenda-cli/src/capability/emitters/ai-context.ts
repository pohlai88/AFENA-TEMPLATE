/**
 * AI context emitter — generates .agents/context/capability-map.md
...
import type { CapabilityKind } from 'afenda-canon';
...
export function generateAiContext(): string {
  ...
  lines.push('');
  lines.push(`> Auto-generated by \`afenda meta gen\`. Do not edit manually.`);
...
/**
 * Write the AI context to .agents/context/capability-map.md
 */
