...
<!-- Signature: sha256:01c7ef81f9adc7e3669f4ec46c9b4b1ff8009fbf7163e532afd430f1b6c7f6c7 -->
# quality-metrics
...
| `flakiness` | `tsx src/flakiness.ts` |
| `gates` | `tsx src/gates-cli.ts` |
| `insights` | `tsx src/insights.ts` |
| `performance` | `tsx src/performance.ts` |
...
# Or add from workspace root:
pnpm -w add -D quality-metrics
```
