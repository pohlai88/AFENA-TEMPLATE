...
// Form for Subcontracting Order Service Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { SubcontractingOrderServiceItem } from "../types/subcontracting-order-service-item.js";
import { SubcontractingOrderServiceItemInsertSchema } from "../types/subcontracting-order-service-item.js";
...
interface SubcontractingOrderServiceItemFormProps {
  initialData?: Partial<SubcontractingOrderServiceItem>;
  onSubmit: (data: Partial<SubcontractingOrderServiceItem>) => void;
  mode: "create" | "edit";
  isLoading?: boolean;
}

export function SubcontractingOrderServiceItemForm({ initialData = {}, onSubmit, mode, isLoading }: SubcontractingOrderServiceItemFormProps) {
  const form = useForm<Partial<SubcontractingOrderServiceItem>>({
    resolver: zodResolver(SubcontractingOrderServiceItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Subcontracting Order Service Item" : "New Subcontracting Order Service Item"}
        </h2>
