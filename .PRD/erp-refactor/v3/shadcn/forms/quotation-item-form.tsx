...
// Form for Quotation Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { QuotationItem } from "../types/quotation-item.js";
import { QuotationItemInsertSchema } from "../types/quotation-item.js";
...
export function QuotationItemForm({ initialData = {}, onSubmit, mode, isLoading }: QuotationItemFormProps) {
  const form = useForm<Partial<QuotationItem>>({
    resolver: zodResolver(QuotationItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Quotation Item" : "New Quotation Item"}
        </h2>
            ...
            <FormField control={form.control} name="is_alternative" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Is Alternative</FormLabel>
                </div>
              </FormItem>
            )} />
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="prevdoc_docname" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Against Docname</FormLabel>
                <FormControl>
