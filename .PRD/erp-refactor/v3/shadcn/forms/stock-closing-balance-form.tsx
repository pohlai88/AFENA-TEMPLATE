...
// Form for Stock Closing Balance
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { StockClosingBalance } from "../types/stock-closing-balance.js";
import { StockClosingBalanceInsertSchema } from "../types/stock-closing-balance.js";
...
export function StockClosingBalanceForm({ initialData = {}, onSubmit, mode, isLoading }: StockClosingBalanceFormProps) {
  const form = useForm<Partial<StockClosingBalance>>({
    resolver: zodResolver(StockClosingBalanceInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Stock Closing Balance" : "New Stock Closing Balance"}
        </h2>
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="stock_closing_entry" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Stock Closing Entry (→ Stock Closing Entry)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Stock Closing Entry..." {...f} value={(f.value as string) ?? ""} disabled />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="inventory_dimension_key" render={({ field: f }) => (
              <FormItem className="col-span-2">
                <FormLabel className="">Inventory Dimension key</FormLabel>
                <FormControl>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="fifo_queue" render={({ field: f }) => (
              <FormItem className="col-span-2">
                <FormLabel className="">FIFO Queue</FormLabel>
                <FormControl>
                  <Textarea className="" rows={4} {...f} value={(f.value as string) ?? ""} disabled />
                </FormControl>
                <FormMessage />
