...
// Form for Product Bundle Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { ProductBundleItem } from "../types/product-bundle-item.js";
import { ProductBundleItemInsertSchema } from "../types/product-bundle-item.js";
...
export function ProductBundleItemForm({ initialData = {}, onSubmit, mode, isLoading }: ProductBundleItemFormProps) {
  const form = useForm<Partial<ProductBundleItem>>({
    resolver: zodResolver(ProductBundleItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Product Bundle Item" : "New Product Bundle Item"}
        </h2>
