...
import { TaskTypeInsertSchema } from "../types/task-type.js";
...
export function TaskTypeForm({ initialData = {}, onSubmit, mode, isLoading }: TaskTypeFormProps) {
  const form = useForm<Partial<TaskType>>({
    resolver: zodResolver(TaskTypeInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Task Type" : "New Task Type"}
        </h2>
