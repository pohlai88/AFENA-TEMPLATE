...
import { BomItemInsertSchema } from "../types/bom-item.js";
...
export function BomItemForm({ initialData = {}, onSubmit, mode, isLoading }: BomItemFormProps) {
  const form = useForm<Partial<BomItem>>({
    resolver: zodResolver(BomItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "BOM Item" : "New BOM Item"}
        </h2>
            ...
            <FormField control={form.control} name="operation" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Item operation (→ Operation)</FormLabel>
                <FormControl>
            ...
            <FormField control={form.control} name="operation_row_id" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Operation ID</FormLabel>
                <FormControl>
            ...
            <FormField control={form.control} name="do_not_explode" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Do Not Explode</FormLabel>
                </div>
              </FormItem>
            )} />
            {!form.getValues().do_not_explode && (
            ...
            <FormField control={form.control} name="is_stock_item" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                ...
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Is Stock Item</FormLabel>
                </div>
              </FormItem>
            )} />
      <Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Rate & Amount</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
