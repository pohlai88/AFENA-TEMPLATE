...
// Form for Opportunity Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { OpportunityItem } from "../types/opportunity-item.js";
import { OpportunityItemInsertSchema } from "../types/opportunity-item.js";
...
interface OpportunityItemFormProps {
  initialData?: Partial<OpportunityItem>;
  onSubmit: (data: Partial<OpportunityItem>) => void;
  mode: "create" | "edit";
  isLoading?: boolean;
}

export function OpportunityItemForm({ initialData = {}, onSubmit, mode, isLoading }: OpportunityItemFormProps) {
  const form = useForm<Partial<OpportunityItem>>({
    resolver: zodResolver(OpportunityItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Opportunity Item" : "New Opportunity Item"}
        </h2>
