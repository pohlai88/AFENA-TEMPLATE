...
// Form for Packing Slip Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { PackingSlipItem } from "../types/packing-slip-item.js";
import { PackingSlipItemInsertSchema } from "../types/packing-slip-item.js";
...
export function PackingSlipItemForm({ initialData = {}, onSubmit, mode, isLoading }: PackingSlipItemFormProps) {
  const form = useForm<Partial<PackingSlipItem>>({
    resolver: zodResolver(PackingSlipItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Packing Slip Item" : "New Packing Slip Item"}
        </h2>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="net_weight" render={({ field: f }) => (
              <FormItem>
