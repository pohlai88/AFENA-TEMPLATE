...
// Form for Supplier Quotation Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { SupplierQuotationItem } from "../types/supplier-quotation-item.js";
import { SupplierQuotationItemInsertSchema } from "../types/supplier-quotation-item.js";
...
export function SupplierQuotationItemForm({ initialData = {}, onSubmit, mode, isLoading }: SupplierQuotationItemFormProps) {
  const form = useForm<Partial<SupplierQuotationItem>>({
    resolver: zodResolver(SupplierQuotationItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Supplier Quotation Item" : "New Supplier Quotation Item"}
        </h2>
            ...
            <FormField control={form.control} name="lead_time_days" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Supplier Lead Time (days)</FormLabel>
                <FormControl>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="request_for_quotation" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Request for Quotation (→ Request for Quotation)</FormLabel>
                <FormControl>
