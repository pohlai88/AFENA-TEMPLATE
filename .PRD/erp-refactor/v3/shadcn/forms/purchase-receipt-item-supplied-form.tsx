...
// Form for Purchase Receipt Item Supplied
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { PurchaseReceiptItemSupplied } from "../types/purchase-receipt-item-supplied.js";
import { PurchaseReceiptItemSuppliedInsertSchema } from "../types/purchase-receipt-item-supplied.js";
...
export function PurchaseReceiptItemSuppliedForm({ initialData = {}, onSubmit, mode, isLoading }: PurchaseReceiptItemSuppliedFormProps) {
  const form = useForm<Partial<PurchaseReceiptItemSupplied>>({
    resolver: zodResolver(PurchaseReceiptItemSuppliedInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Purchase Receipt Item Supplied" : "New Purchase Receipt Item Supplied"}
        </h2>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="consumed_qty" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Qty to Be Consumed</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
