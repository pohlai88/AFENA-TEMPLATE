...
import { DeliveryNoteInsertSchema } from "../types/delivery-note.js";
...
export function DeliveryNoteForm({ initialData = {}, onSubmit, mode, isLoading }: DeliveryNoteFormProps) {
  const form = useForm<Partial<DeliveryNote>>({
    resolver: zodResolver(DeliveryNoteInsertSchema),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold tracking-tight">
            {mode === "edit" ? (initialData.customer_name as string) ?? "Delivery Note" : "New Delivery Note"}
          </h2>
          {mode === "edit" && (
        ...
        <Tabs defaultValue="address-&-contact" className="w-full">
          ...
          <TabsContent value="address-&-contact" className="space-y-4">
            ...
            <FormField control={form.control} name="amended_from" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Amended From (→ Delivery Note)</FormLabel>
                <FormControl>
            ...
            <FormField control={form.control} name="issue_credit_note" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Issue Credit Note</FormLabel>
                </div>
              </FormItem>
            )} />
            )}
            ...
            <FormField control={form.control} name="return_against" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Return Against Delivery Note (→ Delivery Note)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Delivery Note..." {...f} value={(f.value as string) ?? ""} disabled />
                </FormControl>
                <FormMessage />
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <FormLabel className="">Delivery Note Item</FormLabel>
              <div className="mt-1 border rounded-md p-4 text-sm text-muted-foreground">
                {/* Child table: Delivery Note Item — integrate with DataTable */}
                <p>Child table for Delivery Note Item</p>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="base_in_words" render={({ field: f }) => (
              <FormItem>
                ...
                <FormDescription>In Words will be visible once you save the Delivery Note.</FormDescription>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="in_words" render={({ field: f }) => (
              <FormItem>
                ...
                <FormDescription>In Words (Export) will be visible once you save the Delivery Note.</FormDescription>
                <FormMessage />
              </FormItem>
            )} />
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="customer_address" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Billing Address Name (→ Address)</FormLabel>
                <FormControl>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="per_installed" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">% Installed</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Transporter Info</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="lr_no" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Transport Receipt No</FormLabel>
                <FormControl>
                  <Input type="text" {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="delivery_trip" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Delivery Trip (→ Delivery Trip)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Delivery Trip..." {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <FormField control={form.control} name="driver" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Driver (→ Driver)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Driver..." {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="lr_date" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Transport Receipt Date</FormLabel>
                <FormControl>
                  <Input type="date" {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="vehicle_no" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Vehicle No</FormLabel>
                <FormControl>
                  <Input type="text" {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="driver_name" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Driver Name</FormLabel>
                <FormControl>
                  <Input type="text" {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="po_no" render={({ field: f }) => (
              <FormItem className="col-span-2">
                <FormLabel className="">Customer's Purchase Order No</FormLabel>
                <FormControl>
                  <Textarea className="" rows={4} {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="print_without_amount" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Print Without Amount</FormLabel>
                </div>
              </FormItem>
            )} />
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="inter_company_reference" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Inter Company Reference (→ Purchase Receipt)</FormLabel>
                <FormControl>
