...
// Form for Incoming Call Handling Schedule
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { IncomingCallHandlingSchedule } from "../types/incoming-call-handling-schedule.js";
import { IncomingCallHandlingScheduleInsertSchema } from "../types/incoming-call-handling-schedule.js";
...
export function IncomingCallHandlingScheduleForm({ initialData = {}, onSubmit, mode, isLoading }: IncomingCallHandlingScheduleFormProps) {
  const form = useForm<Partial<IncomingCallHandlingSchedule>>({
    resolver: zodResolver(IncomingCallHandlingScheduleInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Incoming Call Handling Schedule" : "New Incoming Call Handling Schedule"}
        </h2>
            ...
            <FormField control={form.control} name="agent_group" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Agent Group (→ Employee Group)</FormLabel>
                <FormControl>
