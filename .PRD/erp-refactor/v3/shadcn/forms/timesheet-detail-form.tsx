...
// Form for Timesheet Detail
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { TimesheetDetail } from "../types/timesheet-detail.js";
import { TimesheetDetailInsertSchema } from "../types/timesheet-detail.js";
...
export function TimesheetDetailForm({ initialData = {}, onSubmit, mode, isLoading }: TimesheetDetailFormProps) {
  const form = useForm<Partial<TimesheetDetail>>({
    resolver: zodResolver(TimesheetDetailInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Timesheet Detail" : "New Timesheet Detail"}
        </h2>
            ...
            <FormField control={form.control} name="expected_hours" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Expected Hrs</FormLabel>
                <FormControl>
            ...
            <FormField control={form.control} name="hours" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Hrs</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} />
                </FormControl>
            ...
            <FormField control={form.control} name="completed" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Completed</FormLabel>
                </div>
              </FormItem>
            )} />
      <Card>
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="is_billable" render={({ field: f }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                <FormControl>
                  <Checkbox checked={!!f.value} onCheckedChange={f.onChange} />
                </FormControl>
                <div className="space-y-1 leading-none">
                  <FormLabel className="">Is Billable</FormLabel>
                </div>
              </FormItem>
            )} />
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="base_billing_rate" render={({ field: f }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="base_billing_amount" render={({ field: f }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="base_costing_rate" render={({ field: f }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="base_costing_amount" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Costing Amount</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
            ...
            <FormField control={form.control} name="costing_amount" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Costing Amount</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
