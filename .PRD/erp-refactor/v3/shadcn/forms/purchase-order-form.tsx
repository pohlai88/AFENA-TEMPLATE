...
import { PurchaseOrderInsertSchema } from "../types/purchase-order.js";
...
export function PurchaseOrderForm({ initialData = {}, onSubmit, mode, isLoading }: PurchaseOrderFormProps) {
  const form = useForm<Partial<PurchaseOrder>>({
    resolver: zodResolver(PurchaseOrderInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold tracking-tight">
            {mode === "edit" ? (initialData.supplier_name as string) ?? "Purchase Order" : "New Purchase Order"}
          </h2>
          {mode === "edit" && (
        ...
        <Tabs defaultValue="address-&-contact" className="w-full">
          <TabsList>
            ...
            <TabsTrigger value="drop-ship">Drop Ship</TabsTrigger>
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="order_confirmation_no" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Order Confirmation No</FormLabel>
                <FormControl>
            ...
            {!!form.getValues().order_confirmation_no && (
            <FormField control={form.control} name="order_confirmation_date" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Order Confirmation Date</FormLabel>
                <FormControl>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <div className="mt-1 border rounded-md p-4 text-sm text-muted-foreground">
                {/* Child table: Purchase Order Item — integrate with DataTable */}
                <p>Child table for Purchase Order Item</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <FormLabel className="">Purchase Order Pricing Rule</FormLabel>
              <div className="mt-1 border rounded-md p-4 text-sm text-muted-foreground">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <div className="mt-1 border rounded-md p-4 text-sm text-muted-foreground">
                {/* Child table: Purchase Order Item Supplied — integrate with DataTable */}
                <p>Child table for Purchase Order Item Supplied</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            {!!form.getValues().base_taxes_and_charges_added && (
            ...
            {!!form.getValues().base_taxes_and_charges_deducted && (
            ...
            {!!form.getValues().base_total_taxes_and_charges && (
            ...
            {!!form.getValues().taxes_and_charges_added && (
            ...
            {!!form.getValues().taxes_and_charges_deducted && (
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="advance_paid" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Advance Paid (Company Currency)</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="address_display" render={({ field: f }) => (
              <FormItem className="col-span-2">
                <FormLabel className="">Supplier Address Details</FormLabel>
                <FormControl>
                  <Textarea className="" rows={4} {...f} value={(f.value as string) ?? ""} disabled />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="contact_person" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Supplier Contact (→ Contact)</FormLabel>
                <FormControl>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <FormField control={form.control} name="dispatch_address" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Dispatch Address (→ Address)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Address..." {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="dispatch_address_display" render={({ field: f }) => (
              <FormItem className="col-span-2">
                <FormLabel className="">Dispatch Address Details</FormLabel>
                <FormControl>
                  <Textarea className="" rows={4} {...f} value={(f.value as string) ?? ""} disabled />
                </FormControl>
                <FormMessage />
      ...
      <Card>
        ...
        <CardContent>
          ...
          <TabsContent value="drop-ship" className="space-y-4">
            ...
            <FormField control={form.control} name="customer_contact_person" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Customer Contact (→ Contact)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Contact..." {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
            ...
            <FormField control={form.control} name="customer_contact_display" render={({ field: f }) => (
              <FormItem className="col-span-2">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="per_billed" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">% Billed</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="ref_sq" render={({ field: f }) => (
              <FormItem>
            ...
            <FormField control={form.control} name="amended_from" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Amended From (→ Purchase Order)</FormLabel>
                <FormControl>
            ...
            <FormField control={form.control} name="inter_company_order_reference" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Inter Company Order Reference (→ Sales Order)</FormLabel>
                <FormControl>
