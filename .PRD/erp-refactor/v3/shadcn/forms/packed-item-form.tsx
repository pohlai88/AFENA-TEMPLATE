...
// Form for Packed Item
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { PackedItem } from "../types/packed-item.js";
import { PackedItemInsertSchema } from "../types/packed-item.js";
...
export function PackedItemForm({ initialData = {}, onSubmit, mode, isLoading }: PackedItemFormProps) {
  const form = useForm<Partial<PackedItem>>({
    resolver: zodResolver(PackedItemInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Packed Item" : "New Packed Item"}
        </h2>
            <FormField control={form.control} name="parent_item" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Parent Item (→ Item)</FormLabel>
                <FormControl>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="target_warehouse" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">To Warehouse (Optional) (→ Warehouse)</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Search Warehouse..." {...f} value={(f.value as string) ?? ""} />
                </FormControl>
                <FormMessage />
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="actual_batch_qty" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Actual Batch Quantity</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="picked_qty" render={({ field: f }) => (
              <FormItem>
                <FormLabel className="">Picked Qty</FormLabel>
                <FormControl>
                  <Input type="number" step="any" {...f} value={f.value != null ? Number(f.value) : ""}
                    onChange={e => f.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} disabled />
                </FormControl>
