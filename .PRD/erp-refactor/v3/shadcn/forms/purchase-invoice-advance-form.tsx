...
// Form for Purchase Invoice Advance
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { PurchaseInvoiceAdvance } from "../types/purchase-invoice-advance.js";
import { PurchaseInvoiceAdvanceInsertSchema } from "../types/purchase-invoice-advance.js";
...
export function PurchaseInvoiceAdvanceForm({ initialData = {}, onSubmit, mode, isLoading }: PurchaseInvoiceAdvanceFormProps) {
  const form = useForm<Partial<PurchaseInvoiceAdvance>>({
    resolver: zodResolver(PurchaseInvoiceAdvanceInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Purchase Invoice Advance" : "New Purchase Invoice Advance"}
        </h2>
