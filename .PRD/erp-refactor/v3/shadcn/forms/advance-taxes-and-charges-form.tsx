...
// Form for Advance Taxes and Charges
// Generated from Canon schema — do not edit manually

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import type { AdvanceTaxesAndCharges } from "../types/advance-taxes-and-charges.js";
import { AdvanceTaxesAndChargesInsertSchema } from "../types/advance-taxes-and-charges.js";
...
export function AdvanceTaxesAndChargesForm({ initialData = {}, onSubmit, mode, isLoading }: AdvanceTaxesAndChargesFormProps) {
  const form = useForm<Partial<AdvanceTaxesAndCharges>>({
    resolver: zodResolver(AdvanceTaxesAndChargesInsertSchema),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <h2 className="text-2xl font-bold tracking-tight">
          {mode === "edit" ? "Advance Taxes and Charges" : "New Advance Taxes and Charges"}
        </h2>
              ...
              <FormItem>
                ...
                <Select onValueChange={f.onChange} defaultValue={f.value as string}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="On Paid Amount">On Paid Amount</SelectItem>
