// List scaffold for Asset Capitalization
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AssetCapitalization } from '../types/asset-capitalization.js';

interface AssetCapitalizationListProps {
  data: AssetCapitalization[];
  onRowClick?: (id: string) => void;
}

export function AssetCapitalizationList({ data, onRowClick }: AssetCapitalizationListProps) {
  return (
