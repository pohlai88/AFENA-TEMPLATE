// List scaffold for Opening Invoice Creation Tool Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { OpeningInvoiceCreationToolItem } from '../types/opening-invoice-creation-tool-item.js';

interface OpeningInvoiceCreationToolItemListProps {
  data: OpeningInvoiceCreationToolItem[];
  onRowClick?: (id: string) => void;
}

export function OpeningInvoiceCreationToolItemList({ data, onRowClick }: OpeningInvoiceCreationToolItemListProps) {
  return (
