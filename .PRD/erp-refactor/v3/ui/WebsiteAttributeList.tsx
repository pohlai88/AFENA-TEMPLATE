// List scaffold for Website Attribute
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { WebsiteAttribute } from '../types/website-attribute.js';

interface WebsiteAttributeListProps {
  data: WebsiteAttribute[];
  onRowClick?: (id: string) => void;
}

export function WebsiteAttributeList({ data, onRowClick }: WebsiteAttributeListProps) {
  return (
