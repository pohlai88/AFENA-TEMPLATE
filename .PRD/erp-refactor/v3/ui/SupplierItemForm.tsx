// Form scaffold for Supplier Item
...
export function SupplierItemForm({ initialData = {}, onSubmit, mode }: SupplierItemFormProps) {
  const [formData, setFormData] = useState<Partial<SupplierItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Supplier Item' : 'New Supplier Item'}</h2>
          <div>
