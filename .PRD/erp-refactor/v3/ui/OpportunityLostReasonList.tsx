// List scaffold for Opportunity Lost Reason
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { OpportunityLostReason } from '../types/opportunity-lost-reason.js';

interface OpportunityLostReasonListProps {
  data: OpportunityLostReason[];
  onRowClick?: (id: string) => void;
}

export function OpportunityLostReasonList({ data, onRowClick }: OpportunityLostReasonListProps) {
  return (
