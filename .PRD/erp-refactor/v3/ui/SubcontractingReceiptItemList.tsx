// List scaffold for Subcontracting Receipt Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingReceiptItem } from '../types/subcontracting-receipt-item.js';

interface SubcontractingReceiptItemListProps {
  data: SubcontractingReceiptItem[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingReceiptItemList({ data, onRowClick }: SubcontractingReceiptItemListProps) {
  return (
