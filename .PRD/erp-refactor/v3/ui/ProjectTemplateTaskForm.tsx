// Form scaffold for Project Template Task
...
export function ProjectTemplateTaskForm({ initialData = {}, onSubmit, mode }: ProjectTemplateTaskFormProps) {
  const [formData, setFormData] = useState<Partial<ProjectTemplateTask>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Project Template Task' : 'New Project Template Task'}</h2>
          <div>
