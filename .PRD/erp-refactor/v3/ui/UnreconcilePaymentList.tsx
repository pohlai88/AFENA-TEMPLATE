// List scaffold for Unreconcile Payment
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { UnreconcilePayment } from '../types/unreconcile-payment.js';

interface UnreconcilePaymentListProps {
  data: UnreconcilePayment[];
  onRowClick?: (id: string) => void;
}

export function UnreconcilePaymentList({ data, onRowClick }: UnreconcilePaymentListProps) {
  return (
