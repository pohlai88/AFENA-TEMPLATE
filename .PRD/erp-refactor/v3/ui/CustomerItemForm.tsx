// Form scaffold for Customer Item
...
export function CustomerItemForm({ initialData = {}, onSubmit, mode }: CustomerItemFormProps) {
  const [formData, setFormData] = useState<Partial<CustomerItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Customer Item' : 'New Customer Item'}</h2>
          <div>
