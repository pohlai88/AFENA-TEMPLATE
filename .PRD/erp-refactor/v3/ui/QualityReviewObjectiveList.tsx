// List scaffold for Quality Review Objective
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { QualityReviewObjective } from '../types/quality-review-objective.js';

interface QualityReviewObjectiveListProps {
  data: QualityReviewObjective[];
  onRowClick?: (id: string) => void;
}

export function QualityReviewObjectiveList({ data, onRowClick }: QualityReviewObjectiveListProps) {
  return (
