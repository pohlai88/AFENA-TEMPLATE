// List scaffold for Job Card Scheduled Time
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { JobCardScheduledTime } from '../types/job-card-scheduled-time.js';

interface JobCardScheduledTimeListProps {
  data: JobCardScheduledTime[];
  onRowClick?: (id: string) => void;
}

export function JobCardScheduledTimeList({ data, onRowClick }: JobCardScheduledTimeListProps) {
  return (
