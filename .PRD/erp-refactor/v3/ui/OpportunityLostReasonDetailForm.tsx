// Form scaffold for Opportunity Lost Reason Detail
...
export function OpportunityLostReasonDetailForm({ initialData = {}, onSubmit, mode }: OpportunityLostReasonDetailFormProps) {
  const [formData, setFormData] = useState<Partial<OpportunityLostReasonDetail>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Opportunity Lost Reason Detail' : 'New Opportunity Lost Reason Detail'}</h2>
          <div>
