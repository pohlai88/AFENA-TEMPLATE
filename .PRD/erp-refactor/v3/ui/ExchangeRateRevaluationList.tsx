// List scaffold for Exchange Rate Revaluation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { ExchangeRateRevaluation } from '../types/exchange-rate-revaluation.js';

interface ExchangeRateRevaluationListProps {
  data: ExchangeRateRevaluation[];
  onRowClick?: (id: string) => void;
}

export function ExchangeRateRevaluationList({ data, onRowClick }: ExchangeRateRevaluationListProps) {
  return (
