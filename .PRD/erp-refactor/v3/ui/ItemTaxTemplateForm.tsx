// Form scaffold for Item Tax Template
...
export function ItemTaxTemplateForm({ initialData = {}, onSubmit, mode }: ItemTaxTemplateFormProps) {
  const [formData, setFormData] = useState<Partial<ItemTaxTemplate>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.title ?? 'Item Tax Template' : 'New Item Tax Template'}
      </h2>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          {/* Child table: taxes → Item Tax Template Detail */}
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">Tax Rates</label>
