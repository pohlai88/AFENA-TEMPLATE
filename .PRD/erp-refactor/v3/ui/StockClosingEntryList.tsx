// List scaffold for Stock Closing Entry
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { StockClosingEntry } from '../types/stock-closing-entry.js';

interface StockClosingEntryListProps {
  data: StockClosingEntry[];
  onRowClick?: (id: string) => void;
}

export function StockClosingEntryList({ data, onRowClick }: StockClosingEntryListProps) {
  return (
