// Form scaffold for Request for Quotation Item
...
export function RequestForQuotationItemForm({ initialData = {}, onSubmit, mode }: RequestForQuotationItemFormProps) {
  const [formData, setFormData] = useState<Partial<RequestForQuotationItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Request for Quotation Item' : 'New Request for Quotation Item'}</h2>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <h4 className="font-medium text-gray-700">Quantity & Stock</h4>
        <div className="grid grid-cols-2 gap-4">
          <div>
