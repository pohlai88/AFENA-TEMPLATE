// List scaffold for POS Opening Entry
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PosOpeningEntry } from '../types/pos-opening-entry.js';

interface PosOpeningEntryListProps {
  data: PosOpeningEntry[];
  onRowClick?: (id: string) => void;
}

export function PosOpeningEntryList({ data, onRowClick }: PosOpeningEntryListProps) {
  return (
