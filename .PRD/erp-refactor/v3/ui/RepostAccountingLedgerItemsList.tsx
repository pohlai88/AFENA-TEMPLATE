// List scaffold for Repost Accounting Ledger Items
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { RepostAccountingLedgerItems } from '../types/repost-accounting-ledger-items.js';

interface RepostAccountingLedgerItemsListProps {
  data: RepostAccountingLedgerItems[];
  onRowClick?: (id: string) => void;
}

export function RepostAccountingLedgerItemsList({ data, onRowClick }: RepostAccountingLedgerItemsListProps) {
  return (
