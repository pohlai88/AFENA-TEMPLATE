...
export function SalesOrderForm({ initialData = {}, onSubmit, mode }: SalesOrderFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.customer_name ?? 'Sales Order' : 'New Sales Order'}
      </h2>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          {formData.order_type === 'Maintenance'; && (
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              checked={!!formData.skip_delivery_note}
              onChange={e => handleChange('skip_delivery_note', e.target.checked)}
              className="rounded border-gray-300"
            />
            <label className="text-sm font-medium text-gray-700">Skip Delivery Note</label>
          </div>
          )}
          <div className="flex items-center gap-2">
            <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Amended From (→ Sales Order)</label>
            <div className="relative">
              <input
                type="text"
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {((formData.docstatus === 0 || formData.reserve_stock) && !formData.is_subcontracted) && (
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          {/* Child table: items → Sales Order Item */}
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {!formData.__islocal && !formData.skip_delivery_note_creation && (
          <div>
          ...
          <div>
            ...
            <input
              type="number"
              step="any"
              value={formData.per_picked != null ? Number(formData.per_picked) : ''}
              onChange={e => handleChange('per_picked', e.target.value ? parseFloat(e.target.value) : undefined)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          <div>
            ...
            <select
              value={String(formData.billing_status ?? '')}
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Inter Company Order Reference (→ Purchase Order)</label>
            <div className="relative">
              <input
                type="text"
