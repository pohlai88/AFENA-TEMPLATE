// List scaffold for Sales Taxes and Charges Template
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SalesTaxesAndChargesTemplate } from '../types/sales-taxes-and-charges-template.js';

interface SalesTaxesAndChargesTemplateListProps {
  data: SalesTaxesAndChargesTemplate[];
  onRowClick?: (id: string) => void;
}

export function SalesTaxesAndChargesTemplateList({ data, onRowClick }: SalesTaxesAndChargesTemplateListProps) {
  return (
