// List scaffold for Repost Item Valuation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { RepostItemValuation } from '../types/repost-item-valuation.js';

interface RepostItemValuationListProps {
  data: RepostItemValuation[];
  onRowClick?: (id: string) => void;
}

export function RepostItemValuationList({ data, onRowClick }: RepostItemValuationListProps) {
  return (
