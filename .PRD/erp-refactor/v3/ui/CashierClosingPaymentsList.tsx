// List scaffold for Cashier Closing Payments
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { CashierClosingPayments } from '../types/cashier-closing-payments.js';

interface CashierClosingPaymentsListProps {
  data: CashierClosingPayments[];
  onRowClick?: (id: string) => void;
}

export function CashierClosingPaymentsList({ data, onRowClick }: CashierClosingPaymentsListProps) {
  return (
