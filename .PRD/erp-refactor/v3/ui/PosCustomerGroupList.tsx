// List scaffold for POS Customer Group
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PosCustomerGroup } from '../types/pos-customer-group.js';

interface PosCustomerGroupListProps {
  data: PosCustomerGroup[];
  onRowClick?: (id: string) => void;
}

export function PosCustomerGroupList({ data, onRowClick }: PosCustomerGroupListProps) {
  return (
