// List scaffold for Subcontracting Order Supplied Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingOrderSuppliedItem } from '../types/subcontracting-order-supplied-item.js';

interface SubcontractingOrderSuppliedItemListProps {
  data: SubcontractingOrderSuppliedItem[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingOrderSuppliedItemList({ data, onRowClick }: SubcontractingOrderSuppliedItemListProps) {
  return (
