// List scaffold for Advance Taxes and Charges
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AdvanceTaxesAndCharges } from '../types/advance-taxes-and-charges.js';

interface AdvanceTaxesAndChargesListProps {
  data: AdvanceTaxesAndCharges[];
  onRowClick?: (id: string) => void;
}

export function AdvanceTaxesAndChargesList({ data, onRowClick }: AdvanceTaxesAndChargesListProps) {
  return (
