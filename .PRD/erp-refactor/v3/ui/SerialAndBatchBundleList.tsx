// List scaffold for Serial and Batch Bundle
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SerialAndBatchBundle } from '../types/serial-and-batch-bundle.js';

interface SerialAndBatchBundleListProps {
  data: SerialAndBatchBundle[];
  onRowClick?: (id: string) => void;
}

export function SerialAndBatchBundleList({ data, onRowClick }: SerialAndBatchBundleListProps) {
  return (
