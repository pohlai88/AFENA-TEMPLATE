// List scaffold for BOM Explosion Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { BomExplosionItem } from '../types/bom-explosion-item.js';

interface BomExplosionItemListProps {
  data: BomExplosionItem[];
  onRowClick?: (id: string) => void;
}

export function BomExplosionItemList({ data, onRowClick }: BomExplosionItemListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Qty Consumed Per Unit</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.qty_consumed_per_unit ?? '')}</td>
