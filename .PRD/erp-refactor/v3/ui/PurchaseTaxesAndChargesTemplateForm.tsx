// Form scaffold for Purchase Taxes and Charges Template
...
export function PurchaseTaxesAndChargesTemplateForm({ initialData = {}, onSubmit, mode }: PurchaseTaxesAndChargesTemplateFormProps) {
  const [formData, setFormData] = useState<Partial<PurchaseTaxesAndChargesTemplate>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.title ?? 'Purchase Taxes and Charges Template' : 'New Purchase Taxes and Charges Template'}
      </h2>
          <div>
