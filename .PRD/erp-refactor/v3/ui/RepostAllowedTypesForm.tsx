// Form scaffold for Repost Allowed Types
...
export function RepostAllowedTypesForm({ initialData = {}, onSubmit, mode }: RepostAllowedTypesFormProps) {
  const [formData, setFormData] = useState<Partial<RepostAllowedTypes>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Repost Allowed Types' : 'New Repost Allowed Types'}</h2>
          <div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm font-medium text-gray-700">Allowed</label>
          </div>
