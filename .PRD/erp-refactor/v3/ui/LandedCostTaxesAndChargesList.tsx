// List scaffold for Landed Cost Taxes and Charges
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { LandedCostTaxesAndCharges } from '../types/landed-cost-taxes-and-charges.js';

interface LandedCostTaxesAndChargesListProps {
  data: LandedCostTaxesAndCharges[];
  onRowClick?: (id: string) => void;
}

export function LandedCostTaxesAndChargesList({ data, onRowClick }: LandedCostTaxesAndChargesListProps) {
  return (
