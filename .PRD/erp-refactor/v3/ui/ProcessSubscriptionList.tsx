// List scaffold for Process Subscription
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { ProcessSubscription } from '../types/process-subscription.js';

interface ProcessSubscriptionListProps {
  data: ProcessSubscription[];
  onRowClick?: (id: string) => void;
}

export function ProcessSubscriptionList({ data, onRowClick }: ProcessSubscriptionListProps) {
  return (
