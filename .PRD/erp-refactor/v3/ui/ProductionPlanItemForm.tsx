// Form scaffold for Production Plan Item
...
export function ProductionPlanItemForm({ initialData = {}, onSubmit, mode }: ProductionPlanItemFormProps) {
  const [formData, setFormData] = useState<Partial<ProductionPlanItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Production Plan Item' : 'New Production Plan Item'}</h2>
      ...
      {/* Section: Quantity and Description */}
      <div className="border rounded-lg p-4 space-y-4">
        <h4 className="font-medium text-gray-700">Quantity and Description</h4>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Pending Qty</label>
            <input
              type="number"
              step="any"
              value={formData.pending_qty != null ? Number(formData.pending_qty) : ''}
              onChange={e => handleChange('pending_qty', e.target.value ? parseFloat(e.target.value) : undefined)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">material_request_item</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">temporary name</label>
            <input
              type="text"
              value={String(formData.temporary_name ?? '')}
              onChange={e => handleChange('temporary_name', e.target.value)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
        </div>
