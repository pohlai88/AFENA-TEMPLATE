// Form scaffold for Pricing Rule Item Code
...
export function PricingRuleItemCodeForm({ initialData = {}, onSubmit, mode }: PricingRuleItemCodeFormProps) {
  const [formData, setFormData] = useState<Partial<PricingRuleItemCode>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Pricing Rule Item Code' : 'New Pricing Rule Item Code'}</h2>
