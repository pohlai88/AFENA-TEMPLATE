// Form scaffold for Purchase Taxes and Charges
...
export function PurchaseTaxesAndChargesForm({ initialData = {}, onSubmit, mode }: PurchaseTaxesAndChargesFormProps) {
  const [formData, setFormData] = useState<Partial<PurchaseTaxesAndCharges>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Purchase Taxes and Charges' : 'New Purchase Taxes and Charges'}</h2>
          <div>
            <label className="block text-sm font-medium text-gray-700">Consider Tax or Charge for</label>
            <select
