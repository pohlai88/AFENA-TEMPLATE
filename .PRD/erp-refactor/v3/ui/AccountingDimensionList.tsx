// List scaffold for Accounting Dimension
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AccountingDimension } from '../types/accounting-dimension.js';

interface AccountingDimensionListProps {
  data: AccountingDimension[];
  onRowClick?: (id: string) => void;
}

export function AccountingDimensionList({ data, onRowClick }: AccountingDimensionListProps) {
  return (
