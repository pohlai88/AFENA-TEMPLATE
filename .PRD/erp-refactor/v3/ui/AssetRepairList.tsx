// List scaffold for Asset Repair
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AssetRepair } from '../types/asset-repair.js';

interface AssetRepairListProps {
  data: AssetRepair[];
  onRowClick?: (id: string) => void;
}

export function AssetRepairList({ data, onRowClick }: AssetRepairListProps) {
  return (
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.downtime ?? '')}</td>
