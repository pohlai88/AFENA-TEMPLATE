// List scaffold for Repost Payment Ledger Items
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { RepostPaymentLedgerItems } from '../types/repost-payment-ledger-items.js';

interface RepostPaymentLedgerItemsListProps {
  data: RepostPaymentLedgerItems[];
  onRowClick?: (id: string) => void;
}

export function RepostPaymentLedgerItemsList({ data, onRowClick }: RepostPaymentLedgerItemsListProps) {
  return (
