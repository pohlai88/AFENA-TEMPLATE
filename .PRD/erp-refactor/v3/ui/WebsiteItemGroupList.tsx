// List scaffold for Website Item Group
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { WebsiteItemGroup } from '../types/website-item-group.js';

interface WebsiteItemGroupListProps {
  data: WebsiteItemGroup[];
  onRowClick?: (id: string) => void;
}

export function WebsiteItemGroupList({ data, onRowClick }: WebsiteItemGroupListProps) {
  return (
