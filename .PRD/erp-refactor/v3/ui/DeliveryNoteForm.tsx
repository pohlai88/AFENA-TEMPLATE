// Form scaffold for Delivery Note
...
interface DeliveryNoteFormProps {
  ...
  onSubmit: (data: Partial<DeliveryNote>) => void;
  mode: 'create' | 'edit';
}

export function DeliveryNoteForm({ initialData = {}, onSubmit, mode }: DeliveryNoteFormProps) {
  const [formData, setFormData] = useState<Partial<DeliveryNote>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.customer_name ?? 'Delivery Note' : 'New Delivery Note'}
      </h2>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Amended From (→ Delivery Note)</label>
            <div className="relative">
              <input
                type="text"
          ...
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              checked={!!formData.issue_credit_note}
              onChange={e => handleChange('issue_credit_note', e.target.checked)}
              className="rounded border-gray-300"
            />
            <label className="text-sm font-medium text-gray-700">Issue Credit Note</label>
          </div>
          )}
          {!!formData.is_return && (
          <div>
            <label className="block text-sm font-medium text-gray-700">Return Against Delivery Note (→ Delivery Note)</label>
            <div className="relative">
              <input
                type="text"
                placeholder="Search Delivery Note..."
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Set Source Warehouse (→ Warehouse)</label>
            <div className="relative">
              <input
                type="text"
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          {/* Child table: items → Delivery Note Item */}
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {!!formData.customer && (
          <div>
            <label className="block text-sm font-medium text-gray-700">Billing Address Name (→ Address)</label>
            <div className="relative">
              <input
                type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="number"
              step="any"
              value={formData.per_installed != null ? Number(formData.per_installed) : ''}
              onChange={e => handleChange('per_installed', e.target.value ? parseFloat(e.target.value) : undefined)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          )}
          <div>
            <label className="block text-sm font-medium text-gray-700">Installation Status</label>
            <select
              value={String(formData.installation_status ?? '')}
      ...
      {/* Section: Transporter Info */}
      <div className="border rounded-lg p-4 space-y-4">
        <h4 className="font-medium text-gray-700">Transporter Info</h4>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Transporter (→ Supplier)</label>
            <div className="relative">
              <input
                type="text"
                placeholder="Search Supplier..."
                value={String(formData.transporter ?? '')}
                onChange={e => {
                  handleChange('transporter', e.target.value);
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Transport Receipt No</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Delivery Trip (→ Delivery Trip)</label>
            <div className="relative">
              <input
                type="text"
                placeholder="Search Delivery Trip..."
                value={String(formData.delivery_trip ?? '')}
                onChange={e => {
                  handleChange('delivery_trip', e.target.value);
                  // TODO: Implement async search for Delivery Trip
                  // fetch(`/api/resource/Delivery Trip?filters=[["name","like","${e.target.value}%"]]&limit=10`)
                  //   .then(r => r.json()).then(data => setSuggestions(data.data));
                }}
                className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                autoComplete="off"
                data-doctype="Delivery Trip"
                data-fieldname="delivery_trip"
              />
              {/* Link indicator */}
              {formData.delivery_trip && (
                <button
                  type="button"
                  onClick={() => handleChange('delivery_trip', '')}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
                  aria-label="Clear"
                >
                  ×
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Driver (→ Driver)</label>
            <div className="relative">
              <input
                type="text"
                placeholder="Search Driver..."
                value={String(formData.driver ?? '')}
                onChange={e => {
                  handleChange('driver', e.target.value);
                  // TODO: Implement async search for Driver
                  // fetch(`/api/resource/Driver?filters=[["name","like","${e.target.value}%"]]&limit=10`)
                  //   .then(r => r.json()).then(data => setSuggestions(data.data));
                }}
                className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                autoComplete="off"
                data-doctype="Driver"
                data-fieldname="driver"
              />
              {/* Link indicator */}
              {formData.driver && (
                <button
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Transport Receipt Date</label>
            <input
              type="date"
          ...
          <div>
            ...
            <input
              type="text"
              value={String(formData.vehicle_no ?? '')}
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">Customer's Purchase Order No</label>
            <textarea
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              checked={!!formData.print_without_amount}
              onChange={e => handleChange('print_without_amount', e.target.checked)}
              className="rounded border-gray-300"
            />
            <label className="text-sm font-medium text-gray-700">Print Without Amount</label>
          </div>
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Inter Company Reference (→ Purchase Receipt)</label>
            <div className="relative">
              <input
                type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Excise Page Number</label>
            <input
              type="text"
              value={String(formData.excise_page ?? '')}
              onChange={e => handleChange('excise_page', e.target.value)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          <div className="col-span-2">
