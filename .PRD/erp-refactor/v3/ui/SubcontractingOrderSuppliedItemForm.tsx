// Form scaffold for Subcontracting Order Supplied Item
...
export function SubcontractingOrderSuppliedItemForm({ initialData = {}, onSubmit, mode }: SubcontractingOrderSuppliedItemFormProps) {
  const [formData, setFormData] = useState<Partial<SubcontractingOrderSuppliedItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Subcontracting Order Supplied Item' : 'New Subcontracting Order Supplied Item'}</h2>
          <div>
