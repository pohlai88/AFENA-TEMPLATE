// Form scaffold for Payment Terms Template Detail
...
export function PaymentTermsTemplateDetailForm({ initialData = {}, onSubmit, mode }: PaymentTermsTemplateDetailFormProps) {
  const [formData, setFormData] = useState<Partial<PaymentTermsTemplateDetail>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Payment Terms Template Detail' : 'New Payment Terms Template Detail'}</h2>
          <div>
