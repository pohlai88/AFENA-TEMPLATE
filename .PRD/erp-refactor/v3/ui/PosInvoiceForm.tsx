...
export function PosInvoiceForm({ initialData = {}, onSubmit, mode }: PosInvoiceFormProps) {
  const [formData, setFormData] = useState<Partial<PosInvoice>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.customer_name ?? 'POS Invoice' : 'New POS Invoice'}
      </h2>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Amended From (→ POS Invoice)</label>
            <div className="relative">
              <input
                type="text"
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* Child table: items → POS Invoice Item */}
