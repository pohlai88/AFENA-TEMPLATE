// List scaffold for Bank Transaction
...
export function BankTransactionList({ data, onRowClick }: BankTransactionListProps) {
  return (
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.deposit ?? '')}</td>
              <td className="px-4 py-3 text-sm">{String(row.withdrawal ?? '')}</td>
