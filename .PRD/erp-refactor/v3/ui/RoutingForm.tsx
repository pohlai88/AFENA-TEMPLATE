...
export function RoutingForm({ initialData = {}, onSubmit, mode }: RoutingFormProps) {
  const [formData, setFormData] = useState<Partial<Routing>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Routing' : 'New Routing'}</h2>
          <div>
            <label className="block text-sm font-medium text-gray-700">Routing Name</label>
            <input
              type="text"
              value={String(formData.routing_name ?? '')}
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">BOM Operation</label>
