// List scaffold for Asset Capitalization Service Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AssetCapitalizationServiceItem } from '../types/asset-capitalization-service-item.js';

interface AssetCapitalizationServiceItemListProps {
  data: AssetCapitalizationServiceItem[];
  onRowClick?: (id: string) => void;
}

export function AssetCapitalizationServiceItemList({ data, onRowClick }: AssetCapitalizationServiceItemListProps) {
  return (
