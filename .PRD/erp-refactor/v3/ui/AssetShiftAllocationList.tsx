// List scaffold for Asset Shift Allocation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AssetShiftAllocation } from '../types/asset-shift-allocation.js';

interface AssetShiftAllocationListProps {
  data: AssetShiftAllocation[];
  onRowClick?: (id: string) => void;
}

export function AssetShiftAllocationList({ data, onRowClick }: AssetShiftAllocationListProps) {
  return (
