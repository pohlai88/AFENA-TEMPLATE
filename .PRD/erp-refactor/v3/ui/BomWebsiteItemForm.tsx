// Form scaffold for BOM Website Item
...
export function BomWebsiteItemForm({ initialData = {}, onSubmit, mode }: BomWebsiteItemFormProps) {
  const [formData, setFormData] = useState<Partial<BomWebsiteItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'BOM Website Item' : 'New BOM Website Item'}</h2>
          <div>
