// Form scaffold for BOM Scrap Item
...
export function BomScrapItemForm({ initialData = {}, onSubmit, mode }: BomScrapItemFormProps) {
  const [formData, setFormData] = useState<Partial<BomScrapItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'BOM Scrap Item' : 'New BOM Scrap Item'}</h2>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Basic Amount (Company Currency)</label>
            <input
              type="number"
              step="any"
