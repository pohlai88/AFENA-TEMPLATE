// Form scaffold for Sales Taxes and Charges Template
...
export function SalesTaxesAndChargesTemplateForm({ initialData = {}, onSubmit, mode }: SalesTaxesAndChargesTemplateFormProps) {
  const [formData, setFormData] = useState<Partial<SalesTaxesAndChargesTemplate>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.title ?? 'Sales Taxes and Charges Template' : 'New Sales Taxes and Charges Template'}
      </h2>
          <div>
