// List scaffold for BOM Update Log
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { BomUpdateLog } from '../types/bom-update-log.js';

interface BomUpdateLogListProps {
  data: BomUpdateLog[];
  onRowClick?: (id: string) => void;
}

export function BomUpdateLogList({ data, onRowClick }: BomUpdateLogListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Update Type</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.update_type ?? '')}</td>
