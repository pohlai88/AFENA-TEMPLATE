// List scaffold for Payment Entry Deduction
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PaymentEntryDeduction } from '../types/payment-entry-deduction.js';

interface PaymentEntryDeductionListProps {
  data: PaymentEntryDeduction[];
  onRowClick?: (id: string) => void;
}

export function PaymentEntryDeductionList({ data, onRowClick }: PaymentEntryDeductionListProps) {
  return (
