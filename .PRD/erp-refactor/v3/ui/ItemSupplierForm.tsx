// Form scaffold for Item Supplier
...
export function ItemSupplierForm({ initialData = {}, onSubmit, mode }: ItemSupplierFormProps) {
  const [formData, setFormData] = useState<Partial<ItemSupplier>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Item Supplier' : 'New Item Supplier'}</h2>
          <div>
