// Form scaffold for Availability Of Slots
...
export function AvailabilityOfSlotsForm({ initialData = {}, onSubmit, mode }: AvailabilityOfSlotsFormProps) {
  const [formData, setFormData] = useState<Partial<AvailabilityOfSlots>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Availability Of Slots' : 'New Availability Of Slots'}</h2>
          <div>
