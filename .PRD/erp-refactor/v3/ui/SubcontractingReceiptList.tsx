// List scaffold for Subcontracting Receipt
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingReceipt } from '../types/subcontracting-receipt.js';

interface SubcontractingReceiptListProps {
  data: SubcontractingReceipt[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingReceiptList({ data, onRowClick }: SubcontractingReceiptListProps) {
  return (
