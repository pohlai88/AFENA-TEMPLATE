// Form scaffold for BOM Explosion Item
...
export function BomExplosionItemForm({ initialData = {}, onSubmit, mode }: BomExplosionItemFormProps) {
  const [formData, setFormData] = useState<Partial<BomExplosionItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'BOM Explosion Item' : 'New BOM Explosion Item'}</h2>
          <div>
