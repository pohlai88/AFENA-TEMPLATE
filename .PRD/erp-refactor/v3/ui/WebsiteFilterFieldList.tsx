// List scaffold for Website Filter Field
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { WebsiteFilterField } from '../types/website-filter-field.js';

interface WebsiteFilterFieldListProps {
  data: WebsiteFilterField[];
  onRowClick?: (id: string) => void;
}

export function WebsiteFilterFieldList({ data, onRowClick }: WebsiteFilterFieldListProps) {
  return (
