// Form scaffold for Price List Country
...
export function PriceListCountryForm({ initialData = {}, onSubmit, mode }: PriceListCountryFormProps) {
  const [formData, setFormData] = useState<Partial<PriceListCountry>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Price List Country' : 'New Price List Country'}</h2>
          <div>
