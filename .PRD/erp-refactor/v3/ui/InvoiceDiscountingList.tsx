// List scaffold for Invoice Discounting
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { InvoiceDiscounting } from '../types/invoice-discounting.js';

interface InvoiceDiscountingListProps {
  data: InvoiceDiscounting[];
  onRowClick?: (id: string) => void;
}

export function InvoiceDiscountingList({ data, onRowClick }: InvoiceDiscountingListProps) {
  return (
