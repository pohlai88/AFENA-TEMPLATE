// List scaffold for Installation Note
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { InstallationNote } from '../types/installation-note.js';

interface InstallationNoteListProps {
  data: InstallationNote[];
  onRowClick?: (id: string) => void;
}

export function InstallationNoteList({ data, onRowClick }: InstallationNoteListProps) {
  return (
