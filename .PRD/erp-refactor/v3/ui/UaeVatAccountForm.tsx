// Form scaffold for UAE VAT Account
...
export function UaeVatAccountForm({ initialData = {}, onSubmit, mode }: UaeVatAccountFormProps) {
  const [formData, setFormData] = useState<Partial<UaeVatAccount>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'UAE VAT Account' : 'New UAE VAT Account'}</h2>
          <div>
