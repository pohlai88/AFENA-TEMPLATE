// Form scaffold for Sales Invoice Advance
...
export function SalesInvoiceAdvanceForm({ initialData = {}, onSubmit, mode }: SalesInvoiceAdvanceFormProps) {
  const [formData, setFormData] = useState<Partial<SalesInvoiceAdvance>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Sales Invoice Advance' : 'New Sales Invoice Advance'}</h2>
          <div>
