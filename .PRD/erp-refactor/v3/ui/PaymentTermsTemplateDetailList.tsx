// List scaffold for Payment Terms Template Detail
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PaymentTermsTemplateDetail } from '../types/payment-terms-template-detail.js';

interface PaymentTermsTemplateDetailListProps {
  data: PaymentTermsTemplateDetail[];
  onRowClick?: (id: string) => void;
}

export function PaymentTermsTemplateDetailList({ data, onRowClick }: PaymentTermsTemplateDetailListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Payment Term</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.payment_term ?? '')}</td>
