// List scaffold for Landed Cost Voucher
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { LandedCostVoucher } from '../types/landed-cost-voucher.js';

interface LandedCostVoucherListProps {
  data: LandedCostVoucher[];
  onRowClick?: (id: string) => void;
}

export function LandedCostVoucherList({ data, onRowClick }: LandedCostVoucherListProps) {
  return (
