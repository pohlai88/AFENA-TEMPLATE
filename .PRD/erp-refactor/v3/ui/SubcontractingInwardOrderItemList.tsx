// List scaffold for Subcontracting Inward Order Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingInwardOrderItem } from '../types/subcontracting-inward-order-item.js';

interface SubcontractingInwardOrderItemListProps {
  data: SubcontractingInwardOrderItem[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingInwardOrderItemList({ data, onRowClick }: SubcontractingInwardOrderItemListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Delivery Warehouse</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.delivery_warehouse ?? '')}</td>
