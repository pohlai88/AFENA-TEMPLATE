// Form scaffold for Journal Entry Template Account
...
export function JournalEntryTemplateAccountForm({ initialData = {}, onSubmit, mode }: JournalEntryTemplateAccountFormProps) {
  const [formData, setFormData] = useState<Partial<JournalEntryTemplateAccount>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Journal Entry Template Account' : 'New Journal Entry Template Account'}</h2>
          <div>
