// List scaffold for Stock Closing Balance
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { StockClosingBalance } from '../types/stock-closing-balance.js';

interface StockClosingBalanceListProps {
  data: StockClosingBalance[];
  onRowClick?: (id: string) => void;
}

export function StockClosingBalanceList({ data, onRowClick }: StockClosingBalanceListProps) {
  return (
