// Form scaffold for Journal Entry Account
...
export function JournalEntryAccountForm({ initialData = {}, onSubmit, mode }: JournalEntryAccountFormProps) {
  const [formData, setFormData] = useState<Partial<JournalEntryAccount>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Journal Entry Account' : 'New Journal Entry Account'}</h2>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Debit in Company Currency</label>
            <input
              type="number"
              step="any"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Credit in Company Currency</label>
            <input
              type="number"
              step="any"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            >
              ...
              <option value="Full and Final Statement">Full and Final Statement</option>
          ...
          {formData.reference_type&&!in_list(formData.reference_type, ['Expense Claim', 'Asset', 'Employee Loan', 'Employee Advance']) && (
          <div>
            <label className="block text-sm font-medium text-gray-700">Reference Due Date</label>
            <input
              type="date"
              value={String(formData.reference_due_date ?? '')}
              onChange={e => handleChange('reference_due_date', e.target.value)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          )}
          <div>
            <label className="block text-sm font-medium text-gray-700">Reference Detail No</label>
            <input
              type="text"
              value={String(formData.reference_detail_no ?? '')}
              onChange={e => handleChange('reference_detail_no', e.target.value)}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          <div>
