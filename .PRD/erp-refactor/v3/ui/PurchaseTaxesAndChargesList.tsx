// List scaffold for Purchase Taxes and Charges
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PurchaseTaxesAndCharges } from '../types/purchase-taxes-and-charges.js';

interface PurchaseTaxesAndChargesListProps {
  data: PurchaseTaxesAndCharges[];
  onRowClick?: (id: string) => void;
}

export function PurchaseTaxesAndChargesList({ data, onRowClick }: PurchaseTaxesAndChargesListProps) {
  return (
