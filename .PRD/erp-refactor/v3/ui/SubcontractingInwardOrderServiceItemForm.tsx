// Form scaffold for Subcontracting Inward Order Service Item
...
export function SubcontractingInwardOrderServiceItemForm({ initialData = {}, onSubmit, mode }: SubcontractingInwardOrderServiceItemFormProps) {
  const [formData, setFormData] = useState<Partial<SubcontractingInwardOrderServiceItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Subcontracting Inward Order Service Item' : 'New Subcontracting Inward Order Service Item'}</h2>
          <div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Finished Good Item (→ Item)</label>
            <div className="relative">
              <input
                type="text"
                placeholder="Search Item..."
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Finished Good Item Quantity</label>
            <input
              type="number"
              step="any"
