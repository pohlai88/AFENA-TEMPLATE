// List scaffold for Appointment Booking Slots
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AppointmentBookingSlots } from '../types/appointment-booking-slots.js';

interface AppointmentBookingSlotsListProps {
  data: AppointmentBookingSlots[];
  onRowClick?: (id: string) => void;
}

export function AppointmentBookingSlotsList({ data, onRowClick }: AppointmentBookingSlotsListProps) {
  return (
