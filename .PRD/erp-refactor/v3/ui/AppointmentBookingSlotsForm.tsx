// Form scaffold for Appointment Booking Slots
...
export function AppointmentBookingSlotsForm({ initialData = {}, onSubmit, mode }: AppointmentBookingSlotsFormProps) {
  const [formData, setFormData] = useState<Partial<AppointmentBookingSlots>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Appointment Booking Slots' : 'New Appointment Booking Slots'}</h2>
          <div>
