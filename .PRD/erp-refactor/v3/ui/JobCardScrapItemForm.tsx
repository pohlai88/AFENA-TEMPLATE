// Form scaffold for Job Card Scrap Item
...
export function JobCardScrapItemForm({ initialData = {}, onSubmit, mode }: JobCardScrapItemFormProps) {
  const [formData, setFormData] = useState<Partial<JobCardScrapItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Job Card Scrap Item' : 'New Job Card Scrap Item'}</h2>
          <div>
            <label className="block text-sm font-medium text-gray-700">Scrap Item Code (→ Item)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Scrap Item Name</label>
            <input
              type="text"
