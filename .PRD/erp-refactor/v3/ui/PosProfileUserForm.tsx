// Form scaffold for POS Profile User
...
export function PosProfileUserForm({ initialData = {}, onSubmit, mode }: PosProfileUserFormProps) {
  const [formData, setFormData] = useState<Partial<PosProfileUser>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'POS Profile User' : 'New POS Profile User'}</h2>
