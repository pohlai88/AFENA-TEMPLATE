// List scaffold for Process Payment Reconciliation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { ProcessPaymentReconciliation } from '../types/process-payment-reconciliation.js';

interface ProcessPaymentReconciliationListProps {
  data: ProcessPaymentReconciliation[];
  onRowClick?: (id: string) => void;
}

export function ProcessPaymentReconciliationList({ data, onRowClick }: ProcessPaymentReconciliationListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Receivable/Payable Account</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.receivable_payable_account ?? '')}</td>
