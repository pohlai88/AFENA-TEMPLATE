// List scaffold for Period Closing Voucher
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PeriodClosingVoucher } from '../types/period-closing-voucher.js';

interface PeriodClosingVoucherListProps {
  data: PeriodClosingVoucher[];
  onRowClick?: (id: string) => void;
}

export function PeriodClosingVoucherList({ data, onRowClick }: PeriodClosingVoucherListProps) {
  return (
