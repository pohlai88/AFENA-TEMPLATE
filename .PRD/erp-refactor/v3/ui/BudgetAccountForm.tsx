// Form scaffold for Budget Account
...
export function BudgetAccountForm({ initialData = {}, onSubmit, mode }: BudgetAccountFormProps) {
  const [formData, setFormData] = useState<Partial<BudgetAccount>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Budget Account' : 'New Budget Account'}</h2>
          <div>
