// List scaffold for Supplier Quotation Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SupplierQuotationItem } from '../types/supplier-quotation-item.js';

interface SupplierQuotationItemListProps {
  data: SupplierQuotationItem[];
  onRowClick?: (id: string) => void;
}

export function SupplierQuotationItemList({ data, onRowClick }: SupplierQuotationItemListProps) {
  return (
