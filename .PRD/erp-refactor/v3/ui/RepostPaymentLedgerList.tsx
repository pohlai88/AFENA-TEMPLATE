// List scaffold for Repost Payment Ledger
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { RepostPaymentLedger } from '../types/repost-payment-ledger.js';

interface RepostPaymentLedgerListProps {
  data: RepostPaymentLedger[];
  onRowClick?: (id: string) => void;
}

export function RepostPaymentLedgerList({ data, onRowClick }: RepostPaymentLedgerListProps) {
  return (
