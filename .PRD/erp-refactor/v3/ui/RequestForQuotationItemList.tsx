// List scaffold for Request for Quotation Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { RequestForQuotationItem } from '../types/request-for-quotation-item.js';

interface RequestForQuotationItemListProps {
  data: RequestForQuotationItem[];
  onRowClick?: (id: string) => void;
}

export function RequestForQuotationItemList({ data, onRowClick }: RequestForQuotationItemListProps) {
  return (
