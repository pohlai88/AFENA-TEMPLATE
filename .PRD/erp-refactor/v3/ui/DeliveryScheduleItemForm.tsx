// Form scaffold for Delivery Schedule Item
...
export function DeliveryScheduleItemForm({ initialData = {}, onSubmit, mode }: DeliveryScheduleItemFormProps) {
  const [formData, setFormData] = useState<Partial<DeliveryScheduleItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">
        {mode === 'edit' ? formData.item_code ?? 'Delivery Schedule Item' : 'New Delivery Schedule Item'}
      </h2>
          <div>
