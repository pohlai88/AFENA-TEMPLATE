// List scaffold for Subcontracting Inward Order Service Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingInwardOrderServiceItem } from '../types/subcontracting-inward-order-service-item.js';

interface SubcontractingInwardOrderServiceItemListProps {
  data: SubcontractingInwardOrderServiceItem[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingInwardOrderServiceItemList({ data, onRowClick }: SubcontractingInwardOrderServiceItemListProps) {
  return (
