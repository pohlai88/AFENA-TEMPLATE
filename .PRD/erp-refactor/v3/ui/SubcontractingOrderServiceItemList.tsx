// List scaffold for Subcontracting Order Service Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SubcontractingOrderServiceItem } from '../types/subcontracting-order-service-item.js';

interface SubcontractingOrderServiceItemListProps {
  data: SubcontractingOrderServiceItem[];
  onRowClick?: (id: string) => void;
}

export function SubcontractingOrderServiceItemList({ data, onRowClick }: SubcontractingOrderServiceItemListProps) {
  return (
