// List scaffold for Delivery Schedule Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { DeliveryScheduleItem } from '../types/delivery-schedule-item.js';

interface DeliveryScheduleItemListProps {
  data: DeliveryScheduleItem[];
  onRowClick?: (id: string) => void;
}

export function DeliveryScheduleItemList({ data, onRowClick }: DeliveryScheduleItemListProps) {
  return (
