// List scaffold for Customer Group Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { CustomerGroupItem } from '../types/customer-group-item.js';

interface CustomerGroupItemListProps {
  data: CustomerGroupItem[];
  onRowClick?: (id: string) => void;
}

export function CustomerGroupItemList({ data, onRowClick }: CustomerGroupItemListProps) {
  return (
