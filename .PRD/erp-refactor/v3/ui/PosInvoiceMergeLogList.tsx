// List scaffold for POS Invoice Merge Log
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PosInvoiceMergeLog } from '../types/pos-invoice-merge-log.js';

interface PosInvoiceMergeLogListProps {
  data: PosInvoiceMergeLog[];
  onRowClick?: (id: string) => void;
}

export function PosInvoiceMergeLogList({ data, onRowClick }: PosInvoiceMergeLogListProps) {
  return (
