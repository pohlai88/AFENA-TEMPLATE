// List scaffold for Pricing Rule Item Group
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PricingRuleItemGroup } from '../types/pricing-rule-item-group.js';

interface PricingRuleItemGroupListProps {
  data: PricingRuleItemGroup[];
  onRowClick?: (id: string) => void;
}

export function PricingRuleItemGroupList({ data, onRowClick }: PricingRuleItemGroupListProps) {
  return (
