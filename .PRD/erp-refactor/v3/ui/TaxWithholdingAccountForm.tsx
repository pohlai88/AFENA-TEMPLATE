// Form scaffold for Tax Withholding Account
...
export function TaxWithholdingAccountForm({ initialData = {}, onSubmit, mode }: TaxWithholdingAccountFormProps) {
  const [formData, setFormData] = useState<Partial<TaxWithholdingAccount>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Tax Withholding Account' : 'New Tax Withholding Account'}</h2>
          <div>
