// Form scaffold for Opportunity Item
...
export function OpportunityItemForm({ initialData = {}, onSubmit, mode }: OpportunityItemFormProps) {
  const [formData, setFormData] = useState<Partial<OpportunityItem>>(initialData);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Opportunity Item' : 'New Opportunity Item'}</h2>
          <div>
