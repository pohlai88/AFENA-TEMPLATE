// List scaffold for Purchase Invoice Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PurchaseInvoiceItem } from '../types/purchase-invoice-item.js';

interface PurchaseInvoiceItemListProps {
  data: PurchaseInvoiceItem[];
  onRowClick?: (id: string) => void;
}

export function PurchaseInvoiceItemList({ data, onRowClick }: PurchaseInvoiceItemListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Accepted Qty</th>
