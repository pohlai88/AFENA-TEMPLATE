// List scaffold for Account Closing Balance
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { AccountClosingBalance } from '../types/account-closing-balance.js';

interface AccountClosingBalanceListProps {
  data: AccountClosingBalance[];
  onRowClick?: (id: string) => void;
}

export function AccountClosingBalanceList({ data, onRowClick }: AccountClosingBalanceListProps) {
  return (
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.closing_date ?? '')}</td>
