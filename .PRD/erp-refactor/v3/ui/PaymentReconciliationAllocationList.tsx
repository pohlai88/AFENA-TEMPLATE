// List scaffold for Payment Reconciliation Allocation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { PaymentReconciliationAllocation } from '../types/payment-reconciliation-allocation.js';

interface PaymentReconciliationAllocationListProps {
  data: PaymentReconciliationAllocation[];
  onRowClick?: (id: string) => void;
}

export function PaymentReconciliationAllocationList({ data, onRowClick }: PaymentReconciliationAllocationListProps) {
  return (
