// List scaffold for Stock Reconciliation Item
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { StockReconciliationItem } from '../types/stock-reconciliation-item.js';

interface StockReconciliationItemListProps {
  data: StockReconciliationItem[];
  onRowClick?: (id: string) => void;
}

export function StockReconciliationItemList({ data, onRowClick }: StockReconciliationItemListProps) {
  return (
