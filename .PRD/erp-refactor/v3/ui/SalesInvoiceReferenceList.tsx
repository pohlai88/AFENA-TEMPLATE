// List scaffold for Sales Invoice Reference
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { SalesInvoiceReference } from '../types/sales-invoice-reference.js';

interface SalesInvoiceReferenceListProps {
  data: SalesInvoiceReference[];
  onRowClick?: (id: string) => void;
}

export function SalesInvoiceReferenceList({ data, onRowClick }: SalesInvoiceReferenceListProps) {
  return (
