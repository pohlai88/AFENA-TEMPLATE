// List scaffold for Work Order Operation
// Generated from Canon schema — do not edit manually
import React from 'react';
import type { WorkOrderOperation } from '../types/work-order-operation.js';

interface WorkOrderOperationListProps {
  data: WorkOrderOperation[];
  onRowClick?: (id: string) => void;
}

export function WorkOrderOperationList({ data, onRowClick }: WorkOrderOperationListProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Semi Finished Goods / Finished Goods</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.fg_warehouse ?? '')}</td>
