// Form scaffold for Contract Template
...
export function ContractTemplateForm({ initialData = {}, onSubmit, mode }: ContractTemplateFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-xl font-semibold">{mode === 'edit' ? 'Contract Template' : 'New Contract Template'}</h2>
          <div>
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">Contract Terms and Conditions</label>
            <textarea
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* Child table: fulfilment_terms → Contract Template Fulfilment Terms */}
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">Fulfilment Terms and Conditions</label>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">Contract Template Help</label>
            <textarea
              value={String(formData.contract_template_help ?? '')}
              onChange={e => handleChange('contract_template_help', e.target.value)}
              rows={4}
              className="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            />
          </div>
