// List scaffold for Market Segment
...
export function MarketSegmentList({ data, onRowClick }: MarketSegmentListProps) {
  return (
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((row) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm">{String(row.market_segment ?? '')}</td>
            </tr>
          ))}
        </tbody>
      </table>
