...
> Auto-generated by `afenda meta gen`. Do not edit manually.
> VIS_POLICY.phase = 3
...
| viewer | `contacts.read`, `contacts.list`, `contacts.versions`, `contacts.audit`, `contacts.search`, `search.global`, `custom_fields.read`, `views.read`, `system.health.read`, `companies.read`, `companies.list`, `companies.versions`, `companies.audit` |
| editor | `contacts.create`, `contacts.update`, `contacts.delete`, `contacts.restore`, `storage.files.upload`, `storage.files.metadata`, `storage.files.save`, `companies.create`, `companies.update`, `companies.delete`, `companies.restore` |
| admin | `admin.custom_fields.define`, `admin.custom_fields.sync`, `admin.aliases.resolve`, `admin.roles.manage`, `admin.views.manage`, `system.workflows.manage` |
...
| `companies.create` | Create a new company | editor | write | active | companies |
| `companies.update` | Update an existing company | editor | write | active | companies |
| `companies.delete` | Soft-delete a company | editor | write | active | companies |
| `companies.restore` | Restore a soft-deleted company | editor | write | active | companies |
...
| `system.health.read` | Health and readiness probes (K8s, load balancers) | viewer | read | active | — |
| `companies.read` | Read a single company | viewer | read | active | companies |
| `companies.list` | List companies | viewer | read | active | companies |
| `companies.versions` | View version history | viewer | read | active | companies |
| `companies.audit` | View audit trail | viewer | read | active | companies |
...
| `admin.roles.manage` | Create and manage roles and permissions | admin | admin | active | roles, role_permissions, user_roles, user_scopes |
...
- **companies**: `companies.create`, `companies.update`, `companies.delete`, `companies.restore`, `companies.read`, `companies.list`, `companies.versions`, `companies.audit`
...
- **role_permissions**: `admin.roles.manage`
- **roles**: `admin.roles.manage`
- **user_roles**: `admin.roles.manage`
- **user_scopes**: `admin.roles.manage`
...
- `admin.roles.manage` — Create and manage roles and permissions
...
- `system.health.read` — Health and readiness probes (K8s, load balancers)
...
- `companies.delete` — risks: irreversible
