...
- `package-development` - Package creation checklist and templates
- `ts-tsup-config` - **TypeScript & tsup config diagnosis and governance** (custom, AFENDA-NEXUS specific)
- `eslint-config` - **ESLint configuration architecture and governance** (custom, AFENDA-NEXUS specific)
