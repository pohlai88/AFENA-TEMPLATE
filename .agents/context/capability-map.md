...
| viewer | `contacts.read`, `contacts.list`, `contacts.versions`, `contacts.audit`, `contacts.search`, `search.global`, `custom_fields.read`, `views.read`, `companies.read`, `companies.list`, `companies.versions`, `companies.audit`         |
