...
- `afena-canon` - Types, Zod schemas, capability system
- `afena-crud` - Kernel mutate(), 19 services, 222 tests passing
- `afena-database` - 72 migrations, RLS on all tables
- `afena-workflow` - V2 engine, 203 tests passing
- `afena-migration` - 112 tests passing, conflict detection
- `afena-advisory` - Math-first (no LLMs), 25 tests
...
# pnpm afena meta handler-emit
# pnpm afena meta bff-emit
# pnpm afena meta registry-emit
