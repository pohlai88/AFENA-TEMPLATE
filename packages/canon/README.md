...
<!-- Signature: sha256:a3bb5b0d8cebce9fff31fb28993ba9db6f815fc63741a09fd361f322b0905e78 -->
# afenda-canon
...
├── src/
    ├── __tests__/ (3 files)
    ├── domain/ — Domain logic and entities (5 files)
    ├── enums/ (26 files)
    ├── lite-meta/ (41 files)
    ├── mappings/ (16 files)
    ├── ports/ (7 files)
    ├── registries/ (19 files)
    ├── schemas/ (31 files)
    ├── types/ — Type definitions and shared interfaces (39 files)
...
- `src/enums/index.ts` — barrel export
- `src/index.ts` — barrel export
- `src/lite-meta/adapters/index.ts` — barrel export
- `src/lite-meta/batch/index.ts` — barrel export
- `src/lite-meta/cache/index.ts` — barrel export
- `src/lite-meta/core/index.ts` — barrel export
- `src/lite-meta/hooks/index.ts` — barrel export
- `src/lite-meta/index.ts` — barrel export
- `src/lite-meta/resilience/index.ts` — barrel export
- `src/lite-meta/types/index.ts` — barrel export
- `src/mappings/index.ts` — barrel export
- `src/ports/index.ts` — barrel export
- `src/registries/index.ts` — barrel export
- `src/schemas/catalog/index.ts` — barrel export
- `src/schemas/index.ts` — barrel export
- `src/types/capability/index.ts` — barrel export
- `src/types/index.ts` — barrel export
- `src/validators/core/index.ts` — barrel export
- `src/validators/index.ts` — barrel export
- `src/validators/presets/index.ts` — barrel export
- `src/validators/rules/index.ts` — barrel export
...
- **`afenda-canon/domain`** — New focused sub-path export for business-domain packages
- **Intent payload governance** — All 37 finance packages type-check clean against canon payloads
- **Branded type helpers** — Three-level `is*()` / `as*()` / `parse*()` for all domain branded types
- **Anti-bloat rules** — Governance comments in barrel; sub-path exports documented
