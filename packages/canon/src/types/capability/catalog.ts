...
export const CAPABILITY_CATALOG: Record<string, CapabilityDescriptor> = {
  ...
  'admin.roles.manage': {
    ...
    intent: 'Create and manage roles and permissions',
    scope: 'org',
    status: 'active',
    entities: ['roles', 'role_permissions', 'user_roles', 'user_scopes'],
    tags: ['admin'],
    headlessOnly: true,
  },
  ...
  'system.health.read': {
    ...
    intent: 'Health and readiness probes (K8s, load balancers)',
    scope: 'global',
    status: 'active',
