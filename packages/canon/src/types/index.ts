...
export type { ErrorCode, KernelError, RetryableReason } from './errors';
...
// Event Types (Phase 2)
export { CANON_EVENT_NAMES, assertCanonEventName } from './events';
export type { CanonEventName, OutboxIntent } from './events';
...
export {
    ...
    CAPABILITY_VERBS, KIND_TO_SCOPE,
    KIND_TO_TIER, RBAC_SCOPES,
    RBAC_TIERS, VERB_TO_KIND,
    VIS_POLICY, inferKindFromVerb, parseCapabilityKey, validateCapabilityKey
} from './capability';
export type {
