...
<!-- Signature: sha256:ba9d7c40e82131cf22a8f251e8b4f07d845cd0c90c2653380e2ad2f4d3c970f0 -->
# afenda-crud
...
📚 Has Documentation • 📁 10 directory areas
...
```
├── src/
    ├── commit/ — Commit or apply logic (9 files)
    ├── deliver/ — Post-commit delivery effects (4 files)
    ├── handlers/ — Request or event handlers (4 files)
    ├── outbox/ — Outbox or queue writers (1 file)
    ├── plan/ — Planning or mutation plan logic (17 files)
    ├── registries/ (1 file)
    ├── services/ — Business logic and services (1 file)
    └── util/ (3 files)
└── docs/ — Documentation and guides (2 files)
```
...
- **`src/commit/`** — Commit or apply logic
- **`src/deliver/`** — Post-commit delivery effects
- **`src/handlers/`** — Request or event handlers
- **`src/outbox/`** — Outbox or queue writers
- **`src/plan/`** — Planning or mutation plan logic
