...
export const TABLE_REGISTRY = {
  account_categories: 'truth',
  accounts_settings: 'truth',
  activity_costs: 'truth',
  activity_types: 'truth',
  addresses: 'truth',
  advisories: 'system',
  advisory_evidence: 'system',
  api_keys: 'system',
  appointment_booking_settings: 'truth',
  ...
  assets: 'truth',
  audit_logs: 'evidence',
  authorization_controls: 'truth',
  authorization_rules: 'truth',
  bank_accounts: 'truth',
  ...
  crm_settings: 'truth',
  currencies: 'truth',
  currency_exchange_settings: 'truth',
  currency_exchange_settings_details: 'truth',
  currency_exchanges: 'truth',
  ...
  payment_terms: 'truth',
  payments: 'truth',
  plaid_settings: 'truth',
  pos_settings: 'truth',
  price_list_items: 'truth',
  price_lists: 'truth',
  project_template_tasks: 'truth',
  project_templates: 'truth',
  project_types: 'truth',
  project_updates: 'truth',
  project_users: 'truth',
  projects: 'truth',
  projects_settings: 'truth',
  psoa_projects: 'truth',
  ...
  repost_accounting_ledger_settings: 'truth',
  ...
  selling_settings: 'truth',
  service_level_agreements: 'truth',
  sites: 'truth',
  south_africa_vat_settings: 'truth',
  stock_balances: 'projection',
  stock_movements: 'truth',
  stock_reposting_settings: 'truth',
  stock_settings: 'truth',
  subscription_settings: 'truth',
  supplier_profiles: 'truth',
  support_settings: 'truth',
  tasks: 'truth',
  tax_rates: 'truth',
  timesheet_details: 'truth',
  timesheets: 'truth',
  uae_vat_settings: 'truth',
  uom: 'truth',
  uom_conversions: 'truth',
  user_roles: 'system',
  user_scopes: 'system',
  users: 'system',
  video_settings: 'truth',
  voice_call_settings: 'truth',
  warehouses: 'truth',
