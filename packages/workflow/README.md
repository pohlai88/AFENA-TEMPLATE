...
<!-- Signature: sha256:1a80768f428c701d5e0b52a3a8f2aff88a335cfd25b398865fbcf59aaf89ed25 -->
# afenda-workflow
...
└── src/
    ├── __tests__/ (2 files)
    └── v2/ — Versioned module (v2) (40 files)
```
...
- `src/v2/index.ts` — barrel export
- `src/v2/nodes/index.ts` — barrel export
...
Layer 2: Domain Services (workflow ← YOU ARE HERE, 116 business-domain packages)
