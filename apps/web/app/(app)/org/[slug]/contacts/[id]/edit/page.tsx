...
import { ContactForm } from '@/app/(app)/org/[slug]/contacts/_components/contact-form_client';
import { readContact } from '@/app/(app)/org/[slug]/contacts/_server/contacts.query_server';
...
export default async function EditContactPage({
  ...
  const [contact, ctx] = await Promise.all([readContact(id), getOrgContext(slug)]);
