...
import CoverageHeatmap from '@/src/components/quality/coverage-heatmap';
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="-mb-px flex space-x-8">
            <button
              ...
              className={`border-b-2 px-1 py-4 text-sm font-medium whitespace-nowrap ${activeTab === 'overview'
            ...
            <button
              ...
              className={`border-b-2 px-1 py-4 text-sm font-medium whitespace-nowrap ${activeTab === 'heatmap'
                ? 'border-blue-500 text-blue-600 dark:border-blue-400 dark:text-blue-400'
                : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                }`}
            >
            ...
            <button
              ...
              className={`border-b-2 px-1 py-4 text-sm font-medium whitespace-nowrap ${activeTab === 'dependencies'
                ? 'border-blue-500 text-blue-600 dark:border-blue-400 dark:text-blue-400'
                : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                }`}
            >
